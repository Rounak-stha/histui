      ...
      <div className="max-w-6xl mx-auto">
        <div className="mb-16">
          ...
          <p className="text-xl text-muted-foreground max-w-2xl">
            From command-line analysis to a comprehensive platform for managing
            code architecture at scale.
          </p>
        </div>
          ...
          <div>
            ...
            <div className="space-y-6">
              {futureFeatures.map((feature, idx) => (
                <div
                  key={idx}
                  className="p-6 border border-border/50 bg-card/25 opacity-75"
                >
