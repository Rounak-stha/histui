		...
		<section className='w-full bg-background py-20 px-4 border-b border-border'>
			<div className='max-w-6xl mx-auto'>
				...
				<div className='mt-16 bg-card/50 border border-border p-12 text-center'>
					<h3 className='text-2xl font-semibold text-foreground mb-3'>Your use case here?</h3>
					<p className='text-muted-foreground mb-6 max-w-xl mx-auto'>
						Every codebase is unique. We're building histui to support diverse workflows and industries.
